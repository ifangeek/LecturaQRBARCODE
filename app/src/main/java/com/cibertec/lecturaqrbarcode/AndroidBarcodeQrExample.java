package com.cibertec.lecturaqrbarcode;
...
public class AndroidBarcodeQrExample extends AppCompatActivity {
    ...
    public void scanBar(View v){
        try {
            ...
            showDialog(AndroidBarcodeQrExample.this, "No hay scanner encontrado", "Descargar el scanner code activity?", "Si", "No").show();
        }
    }
